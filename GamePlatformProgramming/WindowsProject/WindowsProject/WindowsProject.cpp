                     ...
                     _In_ int       nCmdShow)
{
    ...
    _cprintf("WCHARSIZE:%d", sizeof(WCHAR));
...
//
//
#define BUTTONCLICK 1

LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    //_cprintf("WndProc Start:%d\n",message);
    switch (message)
    {
    case WM_CREATE:
        CreateWindow(TEXT("button"), TEXT("Click me"),
            WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
            20, 20, 100, 25, hWnd, (HMENU)BUTTONCLICK, hInst, NULL);
        break;
    case WM_COMMAND:
        {
    ...
    case WM_PAINT:
        ...
        break;
    case WM_DESTROY:
        _cprintf("WM_DESTROY:%d\n", message);
        PostQuitMessage(0);
        break;
    default:
        return DefWindowProc(hWnd, message, wParam, lParam);
    }
    _cprintf("WndProc End:%d\n", message);
    return 0;
}
